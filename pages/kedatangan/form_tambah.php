            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header">
                  <h4>Tambah Data Kedatangan</h4>
                  <div class="card-header-action">
                    <a href="<?php echo $baseUrl; ?>pages/kedatangan/main.php" class="btn btn-danger">Kembali ke Data Kedatangan <i class="fas fa-chevron-right"></i></a>
                  </div>
                </div>
